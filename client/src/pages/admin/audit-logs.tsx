...
export default function AuditLogsPage() {
  ...
  const { data: logsData, isLoading: loadingLogs } = useQuery({
    queryKey: ["/api/audit", page, filters],
    queryFn: async () => {
  ...
  const { data: reports, isLoading: loadingReports } = useQuery({
    ...
    queryFn: async () => {
      const res = await fetch("/api/audit/compliance-reports", { credentials: "include" });
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">{stats?.today || 0} today</p>
          </CardContent>
        </Card>
      ...
      <Tabs defaultValue="logs" className="space-y-4">
        ...
        <TabsContent value="reports" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-3">
            <Card className="hover-elevate cursor-pointer" onClick={() => handleGenerateReport("monthly_summary")}>
              <CardHeader>
                <CardTitle className="text-lg">Monthly Summary</CardTitle>
                <CardDescription>Generate a monthly activity summary report</CardDescription>
              </CardHeader>
              <CardContent>
                <Button className="w-full" disabled={generateReportMutation.isPending}>
            ...
            <Card className="hover-elevate cursor-pointer" onClick={() => handleGenerateReport("pii_access")}>
              <CardHeader>
            ...
            <Card className="hover-elevate cursor-pointer" onClick={() => handleGenerateReport("data_retention")}>
              <CardHeader>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">{selectedLog.resourceType} {selectedLog.resourceId && `(${selectedLog.resourceId})`}</p>
                </div>
                <div>
              ...
              {selectedLog.reviewed && (
                <div className="pt-4 border-t">
                  ...
                  <p className="font-medium">{new Date(selectedLog.reviewedAt!).toLocaleString()}</p>
